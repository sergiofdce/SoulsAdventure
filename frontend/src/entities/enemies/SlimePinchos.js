...
export class SlimePinchos extends Enemy {
    constructor(scene, x, y, texture = "enemy-SlimePinchos") {
        const enemyData = ENEMIES.SlimePinchos;
        ...
        this.type = "SlimePinchos";

        // Iniciar con la animación idle
        this.sprite.play("SlimePinchos-idle");

        // Ruta del spritesheet
        this.spritesheet = "./assets/enemies/enemy-SlimePinchos.png";
    }

    createAnimations(scene) {
        scene.anims.create({
            key: "SlimePinchos-idle",
            frames: scene.anims.generateFrameNumbers("enemy-SlimePinchos", { start: 0, end: 5 }),
            frameRate: 5,
            repeat: -1,
        });

        scene.anims.create({
            key: "SlimePinchos-walk",
            frames: scene.anims.generateFrameNumbers("enemy-SlimePinchos", { start: 0, end: 5 }),
            frameRate: 10,
            repeat: -1,
        });
    ...
    kill() {
        console.log("SlimePinchos killed");
        super.kill();
    }
}
